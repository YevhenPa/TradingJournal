...
import com.trading.journal.service.ImageService;
...
public class DealController {
    ...
    @Autowired
    private DealTotalListService dealTotalListService;
    ...
    public ResponseEntity<?> uploadImageToFileSystem(
        ...
        String uploadImage = imageService.uploadImageFromFileSystem(file, id);
    ...
    public ResponseEntity<?> downloadImageFromFileSystem(
        ...
        byte[][] images = imageService.downloadImageFromFileSystem(id);
    ...
    public void deleteImage(@PathVariable int id, @PathVariable int imgNumber) {
        imageService.deleteImage(id ,imgNumber);
    }
